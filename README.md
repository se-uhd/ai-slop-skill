...
2. **Loads the AI-trope catalog** from the upstream Gist (`https://gist.githubusercontent.com/ossa-ma/f3baa9d25154c33095e22272c631f5a1/raw/`), falling back to the rendered viewer at `https://tropes.fyi/tropes-md` and then to the bundled `shared/tropes-snapshot.md`.
