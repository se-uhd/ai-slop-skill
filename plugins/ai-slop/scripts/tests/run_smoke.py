...
def test_scan_sentences_skips_non_prose_and_kept_sentences():
    md = ('---\ntitle: The title is generated by the tool\n---\n\n'
          ...
          '- Another item.\n\n'
          'The data is kept. <!-- [KEPT: the passive names no actor] -->\n'
          'The flag was set. [KEPT: unknown actor]\n')
    ...
    with tempfile.TemporaryDirectory() as d:
        ...
        # Front matter, heading, code span, fence, block quote, and table add
        # nothing, and both kept sentences drop out. The list item stays.
        ...
        # preamble, comments, verbatim block, quotation, kept sentence, and
        # epilogue list no passive.
...
TESTS = [
    ...
    test_scan_sentences_skips_non_prose_and_kept_sentences,
