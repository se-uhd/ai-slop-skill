...
Issues:
  - cluster:           a single \\cite-style call with three or more keys.
                       The citation-cluster rule (`S.citation-clusters`) asks
                       for a per-work explanation. This check only flags the
                       existence of the cluster. Judging whether the
                       surrounding prose explains each work is left to the
                       caller.
