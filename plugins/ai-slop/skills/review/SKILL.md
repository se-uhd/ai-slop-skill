...
5. **Cross-cutting metrics.** Compute and record the metrics for the layers in scope (skip the scientific metrics, verb-tense compliance and the "significant" audit, when only the general layer is loaded). Run the deterministic scans below first, because the per-section reading pass undercounts glyphs, reference candidates, and sentence lengths:
...
**Paper:** <path>
**Skill version:** 2026-09_rev22 <!-- maintainer: bump on every release (see README "Maintainer notes") -->
