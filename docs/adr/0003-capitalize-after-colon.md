...
The bundle version moves from `2026-05_rev8` to `2026-05_rev9` across the seven surfaces listed in the README's "Maintainer notes."

## Follow-up

- Bump the bundle version from `2026-05_rev8` to `2026-05_rev9` across `plugin.json`, `marketplace.json`, the four `SKILL.md` frontmatter blocks, the report template header in `review/SKILL.md`, and the WRITING.md header in `init/SKILL.md`.
